...
const HELP_CONTENT = {
  homepage: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#售票網站homepage'
  },
  ...
  date_keyword: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#日期關鍵字'
  },
  ...
  area_keyword: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#區域關鍵字'
  },
  ...
  date_auto_fallback: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#日期自動遞補--新功能'
  },
  ...
  discord_webhook_url: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#discord-webhook-通知'
  },
  ...
  telegram_bot_token: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#telegram-bot-通知'
  },
  ...
  server_port: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#設定介面-portserver_port'
  },
  ...
  refresh_datetime: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#刷新在指定時間refresh_datetime'
  },
  ...
  keyword_exclude: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#排除關鍵字'
  },
  ...
  area_auto_fallback: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#區域自動遞補--新功能'
  },
  ...
  show_timestamp: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#顯示時間戳記show_timestamp'
  },
  ...
  reset_browser_interval: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#重新啟動瀏覽器間隔秒reset_browser_interval'
  },
  ...
  proxy_server_port: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#代理伺服器proxy_server_port'
  },
  ...
  disable_adjacent_seat: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#停用相鄰座位disable_adjacent_seat'
  },
  ...
  hide_some_image: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#隱藏部分圖片hide_some_image'
  },
  ...
  block_facebook_network: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#封鎖-facebook-網路block_facebook_network'
  },
  ...
  auto_guess_options: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#自動猜測驗證選項auto_guess_options'
  },
  ...
  ocr_captcha_image_source: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#ocr圖片取得方式image_source'
  },
  ...
  ocr_captcha_use_universal: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#使用通用-ocr-模型use_universal'
  },
  ...
  remote_url: {
    ...
    link: 'https://github.com/azsxdcfv87/tickets_hunter/blob/main/guide/settings-guide.md#設定介面網址remote_url'
  }
};
